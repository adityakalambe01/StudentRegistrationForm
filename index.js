...
const confirmPaswordMessage = document.getElementById(
...
signUpBtn.addEventListener("click", (event) => {
    ...
    let checkPassword =
        validateLowerCase(password.value) &&
    ...
    if (
        ...
        validateEmailId(studEmailId.value) &&
        studGender.value !== "0" &&
        studClass.value !== "0" &&
        checkEmail
    ) {
...
function deleteHobby() {
    ...
    for (let i = 0; i < length; i++) hobbiesList.pop();
}
